...
➜  relearn-helm git:(main) ✗ helm show readme bkstable/mysql
...
By default a random password will be generated for the root user. If youd like to set your own password change the mysqlRootPassword
in the values.yaml.
